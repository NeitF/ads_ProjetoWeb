...
$consulta = "select * from tblNoticias";
...
<!--Fim da Navbar-->
			...
			<div class="container">
				...
				<?php while($dados = mysqli_fetch_array($con)){ ?>
					<div class="col-lg-4 col-sm-12" style="margin-top: 10%;">
								<div class="card mt-5 mybg">
								<a href="#" class="card-link">   														
										<img src=<?php echo "perfil/" .$dados["noti_foto"] ?> class="card-img-top">																				
								</a>
								<div class="card-body blockquote mybg">
									<a href="#" class="card-link">
										<h5 class="card-title text-light"><?php echo $dados["noti_titulo"] ?></h5>
										<hr class="my-2">
										<p class="mytexto card-text"><?php echo $dados["noti_assunto"] ?></p>
									</a>
